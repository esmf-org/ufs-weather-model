...
###############################################################################
if(APP MATCHES "^(ATM|ATMW|ATMWM|ATMAQ|ATML|ATMF|ATMH|ATML-LM4)$")
...
if(APP MATCHES "^(S2S|S2SL|S2SA|S2SW|S2SWL|S2SWA|S2SWAL|S2SH)$")
  ...
  if(APP MATCHES "S2SH")
    set(WRFHYDRO ON  CACHE BOOL "Enable WRFHYDRO"            FORCE)
    string(CONCAT APP_MSG ${APP_MSG} " with Hydrology")
  endif()
